  ...
  return (
    <>
      <div className= "flex flex-col items-center justify-items-center gap-10 mx-24">
        ...
        <div className="mt-16 text-center justify-start text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold font-[orbitron] bg-glow">
        Celebrate our 8th year <br/>supporting open source!</div>

        <div className="text-subtitle text-center text-lg sm:text-2xl font-[orbitron] ">Presented By</div>
