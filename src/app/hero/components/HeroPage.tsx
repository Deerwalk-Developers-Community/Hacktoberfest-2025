  ...
  return (
    <div className="w-full h-full">
      <div className="flex flex-col items-center justify-items-center gap-10 mx-24 h-full">
        ...
        <div className="text-subtitle text-center text-lg sm:text-2xl font-orbitron-regular ">
          Presented By
        </div>
        ...
        <div className="font-bold text-center text-white text-xl sm:text-3xl font-spacegrotesk-regular">
