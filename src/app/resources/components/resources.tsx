...
export default function Resources() {
  return (
    <div className="relative w-full text-white py-8 sm:py-12 lg:py-20 px-8 flex flex-col items-center justify-center  min-h-screen overflow-hidden z-5">
      ...
      <div className="relative z-5 w-full mb-8 sm:mb-12 flex lg:items-start lg:pl-30">
        <PageHeader />
      </div>

      <div className="relative z-5 w-full flex flex-col items-start max-w-6xl lg:pb-20 md:pb-20">
          ...
          {resourceSections.map((section, idx) => (
            <section key={idx} className="">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                {section.icon}
                <h2 className="text-xl sm:text-2xl lg:text-3xl font-orbitron-bold">
                  {section.title}
                </h2>
              </div>

              <div className="ml-14 lg:w-276">
                <ul className="list-disc list-inside text-[#fffff] space-y-1 sm:space-y-2 text-xl font-spacegrotesk-regular ">
